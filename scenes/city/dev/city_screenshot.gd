# Dev tool: render the city dev scene for a few frames and save a screenshot.
# Usage: godot --resolution 1280x720 -s scenes/city/dev/city_screenshot.gd -- /tmp/city.png 240
extends SceneTree

var _frames := 0
var _target_frames := 240
var _out_path := "/tmp/vibe_city_district.png"
var _scene_path := "res://scenes/city/dev/city_dev_screenshot.tscn"
